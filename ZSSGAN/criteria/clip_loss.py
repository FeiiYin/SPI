...
class CLIPLoss(torch.nn.Module):
    def __init__(self, device, lambda_direction=1., lambda_patch=0., lambda_global=0., lambda_manifold=0., lambda_texture=0., patch_loss_type='mae', direction_loss_type='cosine', clip_model='ViT-B/32'):
        ...
        self.device = device
        self.model, clip_preprocess = clip.load(clip_model, device=self.device, download_root='/apdcephfs_cq2/share_1290939/feiiyin/ft_local/')
        ...
        self.model_cnn, preprocess_cnn = clip.load("RN50", device=self.device, download_root='/apdcephfs_cq2/share_1290939/feiiyin/ft_local/')
