...
class IDE3DGenerator(torch.nn.Module):
    ...
    def style(self, z_codes, c, truncation=0.7):
        return self.generator.mapping(z_codes[0], c, truncation_psi=truncation, truncation_cutoff=None)

    def forward(self, styles, c=None, truncation=None, randomize_noise=None): # unused args for compatibility with SG2 interface
        return self.generator.synthesis(styles, c, noise_mode='random', force_fp32=True), None
